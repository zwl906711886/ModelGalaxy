...
if __name__ == '__main__':
    res = load_cifar100_superclass(is_train=True, superclass_type='predefined', n_classes=10, reorganize=True,
                                   target_superclass_idx=1)
    print(len(res))
